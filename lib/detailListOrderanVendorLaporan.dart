...
class DetailListOrderanVendorLaporan extends StatefulWidget {
  final ClassHOrder HOrder;
  DetailListOrderanVendorLaporan(
    {
...
class _MyHomePageState extends State<DetailListOrderanVendorLaporan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:Padding(
        ...
        child: this.HOrder.statusPengiriman==5||this.HOrder.statusPengiriman==5?
        ((this.HOrder.rating==0.0&&this.HOrder.comment=='')?
          ...
          ElevatedButton(
            ...
            child: Text("Lihat Rating & Comment"),
          )
        )
        :
        (
            this.HOrder.jenisPengiriman!=0?
              (
