...
class LaporanPendapatanAdmin extends StatefulWidget {
  final String tglAwal;
  final String tglAkhir;
  LaporanPendapatanAdmin(
    {
...
class _MyHomePageState extends State<LaporanPendapatanAdmin> {
                ...
                child: Center(
                  child:Column(
                    children:[
                      ...
                      SizedBox(height:10.0),
                      Text("Total Pendapatan : Rp "+myFormat.format(this.totalPendapatan).toString(), style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold))
                    ]
                  )
                ),
              ),
  ...
  Widget _buildDailyItem(int index) {
    double totalBiaya = myOrder[index].totalHargaBarang*myOrder[index].appFee/100;
                ...
                Expanded(
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Text("Subtotal Barang Rp "+myFormat.format(myOrder[index].totalHargaBarang).toString(), style:TextStyle(fontWeight: FontWeight.bold)),
                ...
                Expanded(
                  ...
                  child:Container(
                    child: Align(
                      ...
                      child: Text("Rp "+myFormat.format(totalBiaya).toString(), style:TextStyle(fontWeight: FontWeight.bold,fontSize: 13)),
                    ),
                  )
                )
              ]
  ...
  Future<String> getListOrderan() async{
    var url = Uri.parse(globals.ipnumber+'getPendapatanAdmin');
    setState(() {
      myOrder.clear();
      totalPendapatan=0.0;
    });
              ...
              if(status=="Sukses"){
                ...
                for (int i = 0; i < data.length; i++) {
                  ...
                  setState(() {
                    ...
                    totalPendapatan+=dataBaru.appFee/100*dataBaru.totalHargaBarang;
                  });
                }
