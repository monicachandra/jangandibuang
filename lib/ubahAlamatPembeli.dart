...
class UbahAlamatPembeli extends StatefulWidget {
  ...
  final double longi;
  final double lati;
  UbahAlamatPembeli({Key key, @required this.username,@required this.alamat,@required this.kodePos,@required this.keterangan, 
                    @required this.idAlamat,@required this.longi,@required this.lati}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState(this.username,this.alamat,this.kodePos,this.keterangan,this.idAlamat,this.longi,this.lati);
}

class _MyHomePageState extends State<UbahAlamatPembeli> {
  ...
  _MyHomePageState(this.username,this.alamat,this.kodePos,this.keterangan,this.idAlamat,this.longitude,this.latitude){
  ...
  Future<String> simpanAlamat() async{
    var url = Uri.parse(globals.ipnumber+'editAlamatPembeli');
    await http
            .post(url, body: {'idAlamat':this.idAlamat.toString(),'kodePos': kodePosctrl.text, 'latitude':latitude.toString(),'longitude':longitude.toString(),
