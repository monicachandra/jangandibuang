...
import 'package:jangandibuang/detailLaporanPembelianTerbanyak.dart';
...
class LaporanPembelianTerbanyak extends StatefulWidget {
  final String tglAwal;
  final String tglAkhir;
  LaporanPembelianTerbanyak(
    {
...
class _MyHomePageState extends State<LaporanPembelianTerbanyak> {
  String tglAwal,tglAkhir;
  String tipePengurutan="Jumlah Produk Terbeli";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: const Text("Pembeli Terbanyak"),
      ),
      body: ListView(
        children: [
          Padding(
                        ...
                        DropdownButton<String>(
                            ...
                            onChanged: (value){
                              setState(() {
                                ...
                                if(tipePengurutan=="Jumlah Produk Terbeli"){
                                  jenisPengurutan=0;
                                }
                                else{
                                  jenisPengurutan=1;
                            ...
                            items:<String>['Jumlah Produk Terbeli','Nominal Pembelian'].map((String value) {
                              ...
                              return GestureDetector(
                                onTap:(){
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DetailLaporanPembelianTerbanyak(
                                                              ...
                                                              child:Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    child:Align(
                                                                          alignment: Alignment.topRight,
                                                                          child:Text("Produk Terjual : "+arrPenjualan[index].terjual.toString(),style:TextStyle(fontSize: 13))
                                                                        )
                                                                  )
                                                                ],
                                                              )
  ...
  Future<String> getPenjualan() async{
    var url = Uri.parse(globals.ipnumber+'getPembelianTerbanyak');
    setState(() {
      arrPenjualan.clear();
    });
    await http
