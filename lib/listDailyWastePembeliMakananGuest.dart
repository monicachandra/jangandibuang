...
import 'package:jangandibuang/listDailyWasteTokoGuest.dart';
...
class ListDailyWastePembeliMakananGuest extends StatefulWidget {
  final String filter;
  final int kodeList;
  ListDailyWastePembeliMakananGuest(
    {
...
class _MyHomePageState extends State<ListDailyWastePembeliMakananGuest> {
 ...
 _MyHomePageState(this.filter,this.kodeList){
  ...
  Future<String> pindahDetail(int index,int idMakanan,BuildContext context) async{
            ...
            .then((res){
              ...
              if(status=="Sukses"){
                ...
                for (int i = 0; i < data.length; i++) {
                  ...
                  setState(() {
                    dataWastePembeli = ClassDailyWastePembeli(username,logo,menu,rating,myKomentar);                    
                  });
                }
              }
            })
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ListDailyWasteTokoGuest(
