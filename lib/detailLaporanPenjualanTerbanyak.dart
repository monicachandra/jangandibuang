...
class DetailLaporanPenjualanTerbanyak extends StatefulWidget {
  final String username;
  final String tglAwal;
  final String tglAkhir;
  DetailLaporanPenjualanTerbanyak(
    {
...
class _MyHomePageState extends State<DetailLaporanPenjualanTerbanyak> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text("Penjual Terlaris : "+this.username),
      ),
      body:Form(
        key:_formKey,
        child: Column(
