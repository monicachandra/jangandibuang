...
import 'ClassBarangTidakLaku.dart';
import 'ClassDetailWaste.dart';
import 'package:intl/intl.dart';
import 'package:carousel_slider/carousel_slider.dart';

class LaporanBarangTidakLaku extends StatefulWidget {
  final String tglAwal;
  final String tglAkhir;
  LaporanBarangTidakLaku(
    {
...
class _MyHomePageState extends State<LaporanBarangTidakLaku> with SingleTickerProviderStateMixin{
  final List<Tab> myTabs = <Tab>[
    new Tab(text:'Dijual perItem'),
    new Tab(text:'Dijual perPaket'),
  ];
  ...
  int itemTidakLaku=0;
  int paketTidakLaku=0;
  List<ClassBarangTidakLaku> arrWaste = new List.empty(growable: true);
  List<ClassBarangTidakLaku> arrWasteFilter = new List.empty(growable: true);

  List<ClassBarangTidakLaku> arrWastePaket = new List.empty(growable: true);
  List<ClassBarangTidakLaku> arrWasteFilterPaket = new List.empty(growable: true);
  ...
  void _runFilter(String enteredKeyword) {
    List<ClassBarangTidakLaku> results = [];
    ...
    setState(() {
      ...
      for(int i=0;i<arrWasteFilter.length;i++){
        itemTidakLaku+=arrWasteFilter[i].stok;
      }
    });
  }
  void _runFilter2(String enteredKeyword) {
    ...
    setState(() {
      ...
      for(int i=0;i<arrWasteFilterPaket.length;i++){
        paketTidakLaku+=arrWasteFilterPaket[i].stok;
      }
    });
  }
  Widget viewtab0(){
                        ...
                        Center(
                          child:Column(
                            children:[
                              ...
                              Text("Total Item Tidak Laku: "+itemTidakLaku.toString(), style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold)),
                            ]
                          )
                        ),
                        SizedBox(height: 10.0,),
                        ...
                        Center(
                          child:Column(
                            children:[
                              ...
                              , style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold),),
                              SizedBox(height:10.0),
                              Text("Total Paket Tidak Laku: "+paketTidakLaku.toString(), style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold)),
                            ]
                          )
                        ),
                        SizedBox(height: 10.0,),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: const Text("Barang Tidak Laku Terjual"),
        bottom: new TabBar(
  ...
  Widget _buildDailyItem(int index) {
    if(arrWasteFilter[index].isPaket==0){
      return Row(
                  ...
                  child:Column(
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              flex: 1,
                              child:Text(arrWasteFilter[index].kategori.toUpperCase(),
                                style: TextStyle(
                                  fontSize: 12.0,
                            ...
                            Expanded(
                              ...
                              child:Container(
                                      ...
                                      child: Text(arrWasteFilter[index].tanggal,
                                                  style: TextStyle(
                                                    fontSize: 12.0,
                                                    fontWeight: FontWeight.bold,
                                                    color:globals.customGrey))
                        ...
                        Text(arrWasteFilter[index].deskripsi,
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                        SizedBox(height: 3.0),
                        Text("Sisa:"+arrWasteFilter[index].stok.toString()+"/"+arrWasteFilter[index].oriStok.toString()+ " ("+
                              double.parse(arrWasteFilter[index].persentase.toStringAsFixed(2)).toString()+")",
                          style: TextStyle(
                            fontSize: 15.0,
                            color: arrWasteFilter[index].persentase<=0.5?globals.customGreen:globals.customRed,
                            fontWeight: FontWeight.bold)),
                        SizedBox(height:3.0),
                        Align(
                          alignment:Alignment.bottomRight,
                          child:Text("Rp "+myFormat.format(arrWasteFilter[index].hargaWaste).toString(),
        ...
        children: [
          ...
          Expanded(
            ...
            child:Column(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child:Container(
                                alignment:Alignment.topRight,
                                child: Text(arrWasteFilterPaket[index].tanggal,
                                            style: TextStyle(
                                              fontSize: 12.0,
                                              fontWeight: FontWeight.bold,
                                              color:globals.customGrey))
                  ...
                  SizedBox(height: 3.0),
                  Text("Sisa:"+arrWasteFilterPaket[index].stok.toString()+"/"+arrWasteFilterPaket[index].oriStok.toString()+ " ("+
                              double.parse(arrWasteFilterPaket[index].persentase.toStringAsFixed(2)).toString()+")",
                    style: TextStyle(
                      fontSize: 15.0,
                      color: arrWasteFilter[index].persentase<=0.5?globals.customGreen:globals.customRed,
                      fontWeight: FontWeight.bold)),
                  Align(
                    alignment:Alignment.bottomRight,
                    child:Text("Rp "+myFormat.format(arrWasteFilterPaket[index].hargaWaste).toString(),
                                style:TextStyle(fontSize: 20,fontWeight: FontWeight.bold))
                  )
                ]
                ),
  ...
  Future<String> getTidakLaku() async{
    var url = Uri.parse(globals.ipnumber+'getTidakLaku');
    setState(() {
      itemTidakLaku=0;
      arrWaste.clear();
    });
            ...
            .then((res){
              ...
              if(status=="Sukses"){
                ...
                for (int i = 0; i < data.length; i++) {
                  ...
                  int oristok = data[i]['oristok'].toInt();
                  double persentase = (stok/oristok).toDouble();
                  ...
                  ClassBarangTidakLaku databaru = ClassBarangTidakLaku(id,isPaket,idBarang,namaBarang,stok,oristok,persentase,hargaWaste,arrFoto,arrDetail,totalRating,arrKomentar,kategori,deskripsi,tanggal);
                  setState(() {
                    arrWaste.add(databaru);
                    itemTidakLaku+=databaru.stok;
                  }); 
                }
                print("halo");
              }
  ...
  Future<String> getTidakLakuPaket() async{
    var url = Uri.parse(globals.ipnumber+'getTidakLaku');
    setState(() {
      paketTidakLaku=0;
      arrWastePaket.clear();
