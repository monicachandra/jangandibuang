...
import 'package:jangandibuang/ratingDanCommentLaporan.dart';
...
class DetailListOrderanPembeliLaporan extends StatefulWidget {
  final ClassHOrder HOrder;
  DetailListOrderanPembeliLaporan(
    {
...
class _MyHomePageState extends State<DetailListOrderanPembeliLaporan> {
  ...
  void pindahRatingComment(){
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RatingDanCommentLaporan(
          HOrder:this.HOrder
        )
      ) 
