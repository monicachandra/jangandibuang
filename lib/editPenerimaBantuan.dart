...
class EditPenerimaBantuan extends StatefulWidget {
  final ClassAlamat detailAlamat;
  EditPenerimaBantuan(
    {
  ...
  @override
  _MyHomePageState createState() => _MyHomePageState(this.detailAlamat);
}

class _MyHomePageState extends State<EditPenerimaBantuan> {
  ClassAlamat detailAlamat;

  _MyHomePageState(this.detailAlamat){
  ...
  void initState() {
    super.initState();
    this.longitude = detailAlamat.longitude;
    this.latitude = detailAlamat.latitude;
    this.namaPenerima.text = detailAlamat.namaPenerima;
    this.cpPenerima.text = detailAlamat.cp;
    this.noTelp.text = detailAlamat.telp.toString();
    this.jumlahPenerima.text=detailAlamat.jmlPenerima.toString();
    this.catatanTambahan.text=detailAlamat.keterangan;
    this.kodePos.text = detailAlamat.kodePos;
    this.controller.text = detailAlamat.alamat;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: const Text("Sunting Penerima Bantuan"),
        actions: <Widget>[
          IconButton(
  ...
  Future<String> simpanPenerimaBantuan() async{
    var url = Uri.parse(globals.ipnumber+'editPenerimaBantuan');
    await http
            .post(url, body: {'nama': namaPenerima.text, 'alamat': controller.text,'kodePos': kodePos.text, 'latitude':latitude.toString(),'longitude':longitude.toString(),'contact':cpPenerima.text,
                              'noTelp':noTelp.text.toString(),'jumlah':jumlahPenerima.text.toString(),'keterangan':catatanTambahan.text.length==0?"-":catatanTambahan.text,'username':globals.loginuser,'id':detailAlamat.idAlamat.toString()})
            .then((res){
