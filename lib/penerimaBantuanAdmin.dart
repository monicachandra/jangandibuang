...
class PenerimaBantuanAdmin extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PenerimaBantuanAdmin> {
  ...
  Future<String> getDataPengiriman() async{
    ...
    var url = Uri.parse(globals.ipnumber+'getPenerimaBantuan');
    await http
            .get(url)
            .then((res){
