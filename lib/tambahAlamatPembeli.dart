...
class TambahAlamatPembeli extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<TambahAlamatPembeli> {
  ...
  Future<String> simpanAlamat() async{
    var url = Uri.parse(globals.ipnumber+'simpanAlamatPembeli');
    await http
            .post(url, body: {'username':globals.loginuser, 'kodePos': kodePosctrl.text, 'latitude':latitude.toString(),'longitude':longitude.toString(),
