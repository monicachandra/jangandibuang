...
class ListDailyWastePembeli extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<ListDailyWastePembeli> {
  ...
  void pindahFilter(String filter,int kodeList,BuildContext context){
    if(globals.isVerified=="0"){
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ListDailyWastePembeliMakanan(
            filter:filter,
            kodeList:kodeList
          )
        ) 
